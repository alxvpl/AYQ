...
Срещу собствените данни, локално — файловете не напускат машината:

```bash
node src/ayq-cli.ts measure ~/bankafschriften   # само броения, без имена и суми
...
| Одит и измерване | 457 |
| CLI | 173 |
| Тестове и фикстури | 864 |
